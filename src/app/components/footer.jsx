        ...
        <div className="flex flex-wrap justify-center gap-12 w-full">
          ...
          <div>
            ...
            <ul className="flex flex-wrap justify-center gap-6 text-sm items-center">
              <li className="flex items-center gap-2">
                ...
                <Link href="tel:9724086233" className="hover:text-primary hover:underline">
                  972-408-6233
                </Link>
              </li>
              <li className="flex items-center gap-2">
                <IoIosMail className="shrink-0" />
                <Link href="mailto:info@glassgollc.com" className="hover:text-primary hover:underline">
                  info@glassgollc.com
                </Link>
              </li>
              <li className="flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="flex flex-wrap justify-center items-center gap-6 text-sm">
              ...
              <li><Link href="/blog" className="hover:text-primary hover:underline">Tips & Tricks</Link></li>
